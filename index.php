...
';
    ...
    <section class="products">
        <div class="product__center">
                ...
                <div class="product__footer">
                    ...
                    <div class="bottom">
                        <div class="btn__group">
                            <a href="http://localhost:2222//Air_Conditioner/prodect.php?id=1" class="btn view">View</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            if($_GET['countries']!="custom"){
            $q = "SELECT * FROM Region where name = '".$_GET['countries']."'";
            $result = $conn->query($q);
            if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
            $tempmin=$row['tempmin'];
            ...
            if($tempmin!=null){
            $sq="SELECT * FROM prodect where (tempmin<=".$tempmin." and tempmax>=".$tempmax.")and( hummin <=".$hummin."
                    and hummax>=".$hummax." )";
                    }else{
                    $sq="SELECT * FROM prodect";
                    }
                    ...
                    echo ' <div class="product">
                        ...
                        <div class="product__footer">
                            ...
                            <div class="bottom">
                                <div class="btn__group">
                                    <a href="http://localhost:2222//Air_Conditioner/prodect.php?id='.$row['id'].'"
            ...
            <div class="product">
                ...
                <div class="product__footer">
                    <h1>heating radiators oil stove heater</h1>
                    <div class="tag">
                        <span>0C</span>
                        <span>50%</span>
                    </div>
            ...
            <form action="./prodect.php" method="get">
                <input type="hidden" name="veiw" id="veiwid">
                <input type="button" value="" id="m" hidden>
            </form>
    ...
    countries.onchange = function() {
        if (countries.value === "custom") {
            ...
            window.location = ('http://localhost:2222//Air_Conditioner/?countries=' + countries.value);
        }
